...
const char *gost_char_name[256] = {
	"GOST_0",			"GOST_1",
	"GOST_2",			"GOST_3",
	"GOST_4",			"GOST_5",
	"GOST_6",			"GOST_7",
	"GOST_8",			"GOST_9",
	"GOST_PLUS",			"GOST_MINUS",
	"GOST_SOLIDUS",			"GOST_COMMA",
	"GOST_STOP",			"GOST_SPACE",
	"GOST_GOST_LOWER_TEN",		"GOST_UPWARDS_ARROW",
	"GOST_LEFT_PARENTHESIS",	"GOST_RIGHT_PARENTHESIS",
	"GOST_MULTIPLICATION",		"GOST_EQUALS",
	"GOST_SEMICOLON",		"GOST_LEFT_BRACKET",
	"GOST_RIGHT_BRACKET",		"GOST_ASTERISK",
	"GOST_LEFT_QUOTATION",		"GOST_RIGHT_QUOTATION",
	"GOST_NOT_EQUAL_TO",		"GOST_LESS_THAN",
	"GOST_GREATER_THAN",		"GOST_COLON",
	"GOST_A",			"GOST_BE",
	"GOST_B",			"GOST_GHE",
	"GOST_DE",			"GOST_E",
	"GOST_ZHE",			"GOST_ZE",
	"GOST_CYRILLIC_I",		"GOST_SHORT_I",
	"GOST_K",			"GOST_EL",
	"GOST_M",			"GOST_H",
	"GOST_O",			"GOST_PE",
	"GOST_P",			"GOST_C",
	...
	"GOST_TSE",			"GOST_CHE",
	"GOST_SHA",			"GOST_SHCHA",
	"GOST_YERU",			"GOST_SOFT_SIGN",
	"GOST_REVERSE_E",		"GOST_YU",
	"GOST_YA",			"GOST_D",
	"GOST_F",			"GOST_G",
	"GOST_I",			"GOST_J",
	"GOST_L",			"GOST_N",
	...
	"GOST_S",			"GOST_U",
	"GOST_V",			"GOST_W",
	"GOST_Z",			"GOST_OVERLINE",
	"GOST_LESS_THAN_OR_EQUAL",	"GOST_GREATER_THAN_OR_EQUAL",
	"GOST_LOGICAL_OR",		"GOST_LOGICAL_AND",
	"GOST_IMPLICATION",		"GOST_NOT",
	"GOST_DIVISION",		"GOST_IDENTICAL",
	"GOST_PERCENT",			"GOST_LOZENGE",
	"GOST_VERTICAL_LINE",		"GOST_HORIZONTAL_BAR",
	"GOST_LOW_LINE",		"GOST_EXCLAMATION",
	"GOST_QUOTATION",		"GOST_HARD_SIGN",
	"GOST_DEGREE",			"GOST_PRIME",
};
