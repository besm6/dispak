...
e50(void)
{
	...
	case 0165:      /* BESM owner + version + sys. disk info */
		acc.l = koi8_to_gost[(uchar)'B' - 32] << 8 |
			koi8_to_gost[(uchar)'Л' - 32];
		acc.r = koi8_to_gost[(uchar)'А' - 32] << 16 |
			koi8_to_gost[(uchar)'Д' - 32] << 8 |
			koi8_to_gost[(uchar)'E' - 32];
		accex.l = koi8_to_gost[(uchar)'Л' - 32] << 16 |
			koi8_to_gost[(uchar)'Е' - 32] << 8 |
			koi8_to_gost[(uchar)'Ц' - 32];
		accex.r = koi8_to_gost[(uchar)'Э' - 32] << 16 |
			koi8_to_gost[(uchar)'В' - 32] << 8 |
			koi8_to_gost[(uchar)'М' - 32];
		reg[016] = 0x222;
		reg[015] = 2053;
		return E_SUCCESS;
